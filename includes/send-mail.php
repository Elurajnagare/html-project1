...
$strSpam = strip_tags ($_POST['spamField']);
if ( isset( $_POST[ 'g-recaptcha-response' ] ) && empty( $_POST[ 'g-recaptcha-response' ] ) ) {
  $privatekey = '6LcOI8gUAAAAADWlEFGRWkbEQoDJR1K1tXGaVWtT';
  ...
  if(isset($strSpam) && !empty($strSpam)){
    die;
  } else {
  //print_r($_POST);
  ...
  $companyLogo = "https://johnaprobert.co.uk/images/John-A-Probert-Sons-&-Grandsons.png";

  $subject = "Contact Form from ".$companyName;

  $mail = new PHPMailer();
  // $mail->IsSMTP();
  $mail->Host       = "mail.johnaprobert.co.uk"; // SMTP server example
  //$mail->SMTPDebug  = 1;                     // enables SMTP debug information (for testing)
  $mail->SMTPAuth   = true;                  // enable SMTP authentication
  $mail->Port       = 465;            // set the SMTP port for the GMAIL server
  $mail->SMTPSecure = 'ssl';                 
  $mail->SMTPDebug = 2;
  $mail->Username   = "info@johnaprobert.co.uk"; // SMTP account username example
  $mail->Password   = "q@1z&*WVAM23fd8";        // SMTP account password example
  $mail->From = $strEmail;
  $mail->FromName = $strName;
  $mail->SetFrom($strEmail , $strName, 0);
  $mail->AddAddress('info@johnaprobert.co.uk');
  ...
  $mail2 = new PHPMailer();
  // $mail2->IsSMTP();
  $mail2->Host       = "mail.johnaprobert.co.uk"; // SMTP server example
  //$mail->SMTPDebug  = 1;                     // enables SMTP debug information (for testing)
  ...
  $mail2->SetFrom('info@johnaprobert.co.uk' , $companyName, 0);
