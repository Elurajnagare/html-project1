...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-154713286-1"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
    
      gtag('config', 'UA-154713286-1');
    </script>
                ...
                <ul class="menu">
                    ...
                    <li class="">
                        ...
                        <?php /*?><ul>
                            ...
                            <li><a href="decorative-stone">Decorative stone</a>
                        </ul><?php */?>
                    </li>
                    <li><a href="stone-paving">Stone Paving</a></li>
                    <li><a href="sleepers">Sleepers</a></li>
                    <li><a href="areas-we-deliver-to">Areas we deliver to</a></li>
