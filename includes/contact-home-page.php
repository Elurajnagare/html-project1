...
<div class="cotanct_form_wrap">
	<form id="quoteForm">
		<div class="row">
			<div class="col-sm-12 spamField">
				<input type="text" name="spamField" id="spamField" value="" style="visibility: hidden;">
			</div>
			<div class="col-md-6">
			...
			<div class="col-md-12">
				<div class="form-group captcha_wrap">
					...
					<div class="g-recaptcha" data-sitekey="6LcOI8gUAAAAAPNf6Lvqs-z0J2tNAeFX2yeZsK7K"></div>
